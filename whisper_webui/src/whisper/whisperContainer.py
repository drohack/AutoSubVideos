...
from whisper_webui.src.config import ModelConfig, VadInitialPromptMode
from whisper_webui.src.hooks.whisperProgressHook import create_progress_listener_handle

from whisper_webui.src.modelCache import GLOBAL_MODEL_CACHE, ModelCache
from whisper_webui.src.prompts.abstractPromptStrategy import AbstractPromptStrategy
from whisper_webui.src.utils import download_file
from whisper_webui.src.whisper.abstractWhisperContainer import AbstractWhisperCallback, AbstractWhisperContainer
...
class WhisperContainer(AbstractWhisperContainer):
    ...
    def _get_model_path(self, model_config: ModelConfig, root_dir: str = None):
        from whisper_webui.src.conversion.hf_converter import convert_hf_whisper
        """
        Download the model.
