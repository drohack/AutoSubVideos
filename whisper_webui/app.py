...
from whisper_webui.src.config import VAD_INITIAL_PROMPT_MODE_VALUES, ApplicationConfig, VadInitialPromptMode
from whisper_webui.src.diarization.diarization import Diarization
from whisper_webui.src.diarization.diarizationContainer import DiarizationContainer
from whisper_webui.src.diarization.transcriptLoader import load_transcript
from whisper_webui.src.hooks.progressListener import ProgressListener
from whisper_webui.src.hooks.subTaskProgressListener import SubTaskProgressListener
from whisper_webui.src.languages import get_language_names
from whisper_webui.src.modelCache import ModelCache
from whisper_webui.src.prompts.jsonPromptStrategy import JsonPromptStrategy
from whisper_webui.src.prompts.prependPromptStrategy import PrependPromptStrategy
from whisper_webui.src.source import AudioSource, get_audio_source_collection
from whisper_webui.src.vadParallel import ParallelContext, ParallelTranscription
...
from whisper_webui.src.download import ExceededMaximumDuration, download_url
from whisper_webui.src.utils import optional_int, slugify, str2bool, write_srt, write_vtt
from whisper_webui.src.vad import AbstractTranscription, NonSpeechStrategy, PeriodicTranscriptionConfig, TranscriptionConfig, VadPeriodicTranscription, VadSileroTranscription
from whisper_webui.src.whisper.abstractWhisperContainer import AbstractWhisperContainer
from whisper_webui.src.whisper.whisperFactory import create_whisper_container
...
class WhisperTranscriber:
    ...
    def write_srt(self, result: dict, output_filename: str, output_dir: str, highlight_words: bool = False):
        if not os.path.exists(output_dir):
            os.makedirs(output_dir)
        ...
        output_files = []
        output_files.append(self.__create_file(srt, output_dir, output_filename));
