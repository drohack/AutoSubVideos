...
sys.path.append('../whisper_webui')
#print("Sys path: " + str(sys.path))

from whisper_webui.src.whisper.abstractWhisperContainer import LambdaWhisperCallback
from whisper_webui.src.vad import AbstractTranscription, TranscriptionConfig, VadSileroTranscription
