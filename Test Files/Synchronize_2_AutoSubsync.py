...
def synchronize_subtitles(video_file, input_srt_file, output_srt_file):
    print("Start synchronize_subtitles(" +
          ...
          output_srt_file + ")")
    try:
        autosubsync.synchronize(video_file, input_srt_file, output_srt_file)
...
try:
    ...
    output_subtitle_path = directory_path + "/" + os.path.basename(subtitle_path).rstrip(".srt") + ".autosub-sync.srt"
