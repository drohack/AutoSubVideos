...
def transcribe_audio(audio_file_path):
    ...
    transcribe = model.transcribe(audio=audio_file_path, language='en', fp16=False, verbose=False)
    ...
    segments, info = model.transcribe(audio=audio_file_path, beam_size=5, language='en', temperature=0)
    print_with_timestamp("End whisper")
...
try:
    ...
    jp_subtitle_path = directory_path + "/" + os.path.splitext(os.path.basename(video_path))[0] + ".en.srt"
